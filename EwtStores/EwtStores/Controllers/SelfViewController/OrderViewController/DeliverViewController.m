...
- (void)getDataSourceByNetwork:(REQUEST_STATUS)status
{
    ...
    BLOCK_SELF(DeliverViewController);
    ...
    [dic setObject:@"3" forKey:@"type"]; //配送中
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *indifiter = [NSString stringWithFormat:@"deliver_order_cell%d",indexPath.row];
