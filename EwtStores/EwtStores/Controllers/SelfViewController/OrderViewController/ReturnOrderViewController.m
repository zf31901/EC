...
@interface ReturnOrderViewController ()
{
    UIView          *emptyView;
...
- (void)getDataSourceByNetwork:(REQUEST_STATUS)status
{
    ...
    BLOCK_SELF(ReturnOrderViewController);
    ...
    [hq GETURLString:REPAIRS_LIST userCache:NO parameters:dic success:^(AFHTTPRequestOperation *operation, id responseObj) {
        ...
        if([rqDic[HTTP_STATE] boolValue]){
            ...
            for(int i=0; i<dataArr.count; i++){
                NSDictionary *repairDic = (NSDictionary *)dataArr[i];
                NSDictionary *orderDic = (NSDictionary *)[repairDic[@"R_OrderJsonData"] objectFromJSONString];
                
                OrderObj *obj = [OrderObj shareInstance];
                [obj setRepType:[repairDic[@"R_RepState"] intValue]];
                [obj setOrderId:orderDic[@"UO_OrderSerial"]];
                [obj setOrderTime:orderDic[@"UO_SuccessTime"]];
                [obj setDeliverType:[orderDic[@"UO_DeliveryType"] intValue]];
                //订单反馈中调用退换货的状态
                //[obj setStatus:[orderDic[@"UO_Status"] intValue]];
                [obj setStatus:[repairDic[@"R_RepState"] intValue]];
                
                [obj setRecName:orderDic[@"UO_RecName"]];
                [obj setRecAddress:orderDic[@"UO_RecAddress"]];
                [obj setRecMobile:orderDic[@"UO_RecMobile"]];
                [obj setPayType:[orderDic[@"UO_PayType"] intValue]];
                [obj setTotalPrice:[orderDic[@"UO_ProductAmount"] floatValue]];
                [obj setCouponAmount:[orderDic[@"UO_CouponAmount"] floatValue]];
                [obj setGiftsAmount:[orderDic[@"UO_GiftsAmount"] floatValue]];
                [obj setTotalPayAmount:[orderDic[@"UO_TotalPayAmount"] floatValue]];
                [obj setFare:[orderDic[@"UO_Fare"] floatValue]];
                [obj setInvoiceType:orderDic[@"UO_InvoiceType"]];
                [obj setInvoiceHead:orderDic[@"UO_InvoiceHead"]];
                [obj setInvoinceContent:orderDic[@"UO_InvoinceContent"]];
                [obj setRemark:orderDic[@"UO_Remark"]];
                //给订单添加商品
                //[obj setProducts:[self addProducts:dic[@"UO_OrderSerial"]]];
                NSArray *proArr = (NSArray *)[repairDic[@"R_ProductJsonData"] objectFromJSONString];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *indifiter = [NSString stringWithFormat:@"return_order_cell%d",indexPath.row];
