...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%lu successful, %lu skipped, timeElasped %.2f)", (long)(total - self.skippedCount), (unsigned long)self.skippedCount, CFAbsoluteTimeGetCurrent() - self.startedTime);
}
